...
Revised: 2026-07-24 — The handoff now follows the reapproved design and TASK-001 dependency inventory, including exact versions for every direct runtime and development dependency.
...
- Use exactly these runtime dependencies: `next@16.2.11`, `react@19.2.8`, `react-dom@19.2.8`, `@modelcontextprotocol/sdk@1.29.0`, and `zod@4.4.3`.
- Use exactly these development dependencies: `typescript@5.9.3`, `vitest@4.1.10`, `@vitest/coverage-v8@4.1.10`, `eslint@9.39.5`, `eslint-config-next@16.2.11`, `@types/node@24.13.3`, `@types/react@19.2.17`, and `@types/react-dom@19.2.3`.
- Do not add another direct dependency without reopening the SDD workflow.
